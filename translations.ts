export const translations = {
  pt: {
    header: {
      ...
      report: 'Relatório',
      experiences: 'As Nossas Experiências',
      gallery: 'Galeria',
      team: 'Equipa',
      contact: 'Contacto',
    },
    hero: {
      title: 'Bem-vindo à Salama Pemba',
      subtitle: 'A alma de Cabo Delgado - Moçambique',
      button: 'Explore as Nossas Experiências',
    },
    about: {
    ...
    gallery: {
      title: 'Momentos em Pemba',
      subtitle: 'Explore a beleza estonteante e a cultura vibrante de Pemba através das nossas lentes.',
    ...
    contact: {
      ...
      subtitle: 'O seu sonho moçambicano começa aqui. Fale connosco e vamos desenhar juntos uma aventura que irá além das suas expectativas. A magia de Pemba espera por si.',
      location: 'Pemba, Moçambique',
      button: 'Reserve a Sua Experiência',
    },
    footer: {
      description: 'A alma de Cabo Delgado - Moçambique, que proporciona experiências turísticas autênticas e sustentáveis.',
  ...
  en: {
    ...
    hero: {
      title: 'Welcome to Salama Pemba',
      subtitle: 'The soul of Cabo Delgado - Mozambique',
    ...
    gallery: {
      title: 'Moments in Pemba',
      subtitle: 'Explore the stunning beauty and vibrant culture of Pemba through our lenses.',
      close: 'Close viewer',
      prev: 'Previous image',
      next: 'Next image',
    },
    contact: {
      ...
      subtitle: 'Your Mozambican dream starts here. Talk to us, and let\'s design an adventure together that will exceed your expectations. The magic of Pemba awaits.',
      location: 'Pemba, Mozambique',
      button: 'Book Your Experience',
    },
    footer: {
      description: 'The soul of Cabo Delgado - Mozambique, providing authentic and sustainable tourism experiences.',
