        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 text-center md:text-left">
          ...
          <div className="flex flex-col items-center md:items-start">
            ...
            <div className="flex space-x-4 mt-6">
              <a href="#" aria-label="Facebook" className="hover:text-[#4FD1C5] transition-colors">
              ...
              <a href="#" aria-label="Instagram" className="hover:text-[#4FD1C5] transition-colors">
              ...
              <a href="#" aria-label="LinkedIn" className="hover:text-[#4FD1C5] transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-3">
              {navItems.map(item => (
                <li key={item.href}><a href={item.href} className="hover:text-[#4FD1C5] transition-colors">{item.label}</a></li>
              ))}
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-gray-400">
              ...
              <li className="flex items-center justify-center md:justify-start space-x-3">
                ...
                <a href="mailto:reservas@salamapemba.co.mz" className="hover:text-[#4FD1C5] transition-colors">reservas@salamapemba.co.mz</a>
              </li>
              <li className="flex items-center justify-center md:justify-start space-x-3">
                 <svg className="w-5 h-5 text-[#D95F43] flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"></path></svg>
                <a href="tel:+258841234567" className="hover:text-[#4FD1C5] transition-colors">+258 84 123 4567</a>
              </li>
            </ul>
          </div>
        </div>
