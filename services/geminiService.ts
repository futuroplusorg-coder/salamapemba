const createHardcodedDescriptions = (titles: string[]): Record<string, string> => {
  const descriptions: Record<string, string> = {
    ...
    "Visita ao Mercado e Aula de Culinária": "Desperte os seus sentidos com os aromas e sabores locais. Aprenda os segredos da culinária moçambicana numa aula prática e deliciosa.",
